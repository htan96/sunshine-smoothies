...
const CATEGORIES = [
  ...
  { name: "Fuel Packs", href: "/fuel", emoji: "⛽" },
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
        {CATEGORIES.map((cat) => (
          <Link
            key={cat.href}
            href={cat.href}
            className="flex flex-col items-center justify-center p-6 rounded-2xl bg-white border border-neutral-100 hover:border-[var(--color-orange)] hover:shadow-[0_4px_24px_rgba(0,0,0,0.07)] transition text-center"
          >
